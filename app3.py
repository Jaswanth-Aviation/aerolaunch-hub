...
# PAGE 4: NATIVE EMBEDDED CHATBOT INTERFACE
    ...
    if "chat_history" not in st.session_state:
        st.session_state.chat_history = [
            {"role": "assistant", "content": "Welcome to AeroBot. I am structured to assist you directly inside the platform! Ask me about flight forces, airspace classes, or pilot licensing rules below."}
        ]
    ...
    if user_input := st.chat_input("Ask AeroBot a ground question..."):
        ...
        with st.chat_message("assistant", avatar="🤖"):
            ...
            if "force" in query_lower or "aerodynamic" in query_lower:
                bot_reply = """**AeroBot Analysis — The 4 Forces of Flight:**\n\n
...
*In steady, level flight, Lift equals Weight and Thrust equals Drag perfectly.*"""
                ...
                bot_reply = """**AeroBot Analysis — Airspace Classifications:**\n\n
* **Class A:** 18,000 ft MSL up to Flight Level 600. Requires strict Instrument Flight Rules (IFR).\n
* **Class B:** Surface to 10,000 ft MSL around major commercial transport hubs. Requires explicit ATC entry clearance.\n
* **Class C:** Surface to 4,000 ft above airport elevation around busy regional hubs.\n
* **Class D:** Surface to 2,500 ft above airport elevation around smaller towered fields."""
            elif "license" in query_lower or "certify" in query_lower or "pilot" in query_lower:
                bot_reply = """**AeroBot Analysis — Pilot Path Baselines:**\n\n
* **Student Pilot:** Baseline certificate allowing solo operations under flight instructor supervision.\n
* **Private Pilot License (PPL):** Allows navigation of single-engine aircraft anywhere in the US under Visual Flight Rules.\n
* **Commercial Pilot License (CPL):** Authorizes operations for compensation or hire within commercial lines."""
            else:
                bot_reply = f"**AeroBot Status:** Logged query regarding *'{user_input}'*.\n\nTo ensure flawless regulatory precision while additional module nodes clear, use the structured links in your **Pilot Roadmap** and **ATC Roadmap** sections to access interactive ground books!"
