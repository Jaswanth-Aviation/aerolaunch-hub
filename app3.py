...
    st.link_button("Launch AeroBot Training Interface 🚀", "https://schoolaichatbot.zapier.app/", use_container_width=True) is my new code for app3.py and what to change in secrets and requiremtnt.txt
